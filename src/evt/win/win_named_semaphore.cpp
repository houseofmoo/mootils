...
namespace evt {
    ...
    NamedSemaphore::NamedSemaphore(std::int64_t id) : m_dst_id(id), m_sem(nullptr) {
    ...
    NamedSemResult NamedSemaphore::wait(std::uint32_t milliseconds) const {
