...
namespace shm {
   ...
   std::size_t Shm::total_size() const noexcept {
    ...
    ShmResult Shm::read(void* buf, const std::size_t size, const std::size_t offset) const noexcept {
    ...
    ShmResult Shm::write(const void* buf, const std::size_t size, const std::size_t offset) noexcept {
