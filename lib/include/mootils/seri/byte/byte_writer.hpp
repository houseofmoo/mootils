...
namespace seri::byte {
    ...
    class ByteWriter {
        ...
        bool write_bytes(const void* src, std::size_t size);
        ...
        bool write_u8(const std::uint8_t val);
        bool write_i8(const std::int8_t val);
        bool write_byte(const std::byte val);
        bool write_bool(const bool val);

        bool write_u16(const std::uint16_t val);
        bool write_i16(const std::int16_t val);
        
        bool write_u32(const std::uint32_t val);
        bool write_i32(const std::int32_t val);
        
        bool write_u64(const std::uint64_t val);
        bool write_i64(const std::int64_t val);
        
        bool write_float(const float val);
        bool write_double(const double val);

        bool write_char(const char val);
        bool write_string(const std::string_view str);

        template <typename Enum>
        bool write_enum32(const Enum val) noexcept {
        ...
        template <typename Enum>
        bool write_enum16(const Enum val) noexcept {
        ...
        template <typename Enum>
        bool write_enum8(const Enum val) noexcept {
